...
public class DebugDataset {
    ...
    public static DataSet<Centroid> getDefaultCentroidDataSet(ExecutionEnvironment env) {
        ...
        for (Object[] centroid : CENTROIDS) {
            ...
            dimensions[0] = (Double) centroid[1];
            dimensions[1] = (Double) centroid[2];
            centroidList.add(
                    new Centroid((Integer) centroid[0], dimensions));
        }
    ...
    public static DataSet<Point> getDefaultPointDataSet(ExecutionEnvironment env) {
        ...
        for (Object[] point : POINTS) {
            Double[] dimensions = new Double[2];
            dimensions[0] = (Double) point[0];
            dimensions[1] = (Double) point[1];
            pointList.add(new Point(dimensions));
        }
