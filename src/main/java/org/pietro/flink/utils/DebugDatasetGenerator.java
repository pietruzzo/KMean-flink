 ...
 */
public class DebugDatasetGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length < 2) {
            System.out.println("DebugDatasetGenerator -points <num> -k <num clusters> [-output <output-path>] [-stddev <relative stddev>] [-range <centroid range>] [-seed <seed>]");
            System.exit(1);
        }
